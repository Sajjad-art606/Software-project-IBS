    ...
    <header className="flex h-14 shrink-0 items-center gap-3 border-b border-border px-4">
      ...
      <div className="relative min-w-0 flex-1 md:max-w-sm">
        ...
        <input
          ...
          className="flex h-8 w-full rounded-lg border border-input bg-muted/40 pr-3 pl-9 text-sm placeholder:text-muted-foreground focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none"
        />
      </div>
      ...
      {session && (
        <>
          ...
          <div className="relative md:hidden" ref={menuRef}>
            ...
            {menuOpen && (
              <div className="absolute top-full right-0 z-50 mt-1.5 w-52 rounded-xl border border-border bg-popover shadow-lg">
